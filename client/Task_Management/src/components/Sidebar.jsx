    ...
    <>
      <div className='bg-primary-100 dark:bg-secondary-600 flex flex-col justify-between w-[300px] h-full'>
        <div className='flex flex-col pr-6 py-4'>
          ...
          {/* Create new Board */}
          <div className='cursor-pointer pl-8 py-3.5 flex gap-4 text-secondary-200 items-center dark:hover:bg-primary-100 hover:bg-primary-200 hover:rounded-tr-full hover:rounded-br-full '>
            ...
            <h1 className='heading-m text-primary-400 !hover:text-primary-100'>
              + Create New Board
            </h1>
          </div>
        </div>
        ...
        <div className='pr-6'>
          ...
          <div
            ...
            className='mt-2 cursor-pointer pl-8 py-3.5 flex gap-4 text-secondary-200 items-center group dark:hover:bg-primary-00 hover:bg-primary-200 hover:rounded-tr-full hover:rounded-br-full hover:text-primary-400'
          >
            <svg
              width='18'
              height='16'
              xmlns='http://www.w3.org/2000/svg'
              className='group-hover:fill-primary-400 fill-secondary-200'
            >
